<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FoodiesOHH.Admin.Product" %>
<%@ Import Namespace="FoodiesOHH" %>
                             ...
                             <div class="card-block">
                                 ...
                                 <div class="pb-5">
                                     ...
                                     <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-primary"
                                         CausesValidation="false" OnClick="btnClear.Click" />
                                </div> 
                                <div>
                                 ...
                                 <div class="card-block table-border-style">
                                     <div class="table-responsive">
                                         ...
                                         <asp:Repeater ID="rProduct" runat="server" OnItemComman="rProduct_ItemCommand" 
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary" 
                                                             CommandArgument='<%# Eval("CreatedDate") %>' CommandName="edit">
                                                                 <i class="ti-pencil"></i>
                                                         </asp:LinkButton>
                                                         <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                             CssClass="badge bg-danger" CommandArgument='<%# Eval("CreatedDate") %>'
